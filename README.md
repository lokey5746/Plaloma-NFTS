...
```
cd existing_repo
git remote add origin https://gitlab.com/lokeydangi/plaloma-nfts.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/lokeydangi/plaloma-nfts/-/settings/integrations)
